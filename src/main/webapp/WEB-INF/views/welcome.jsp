...
<head>
    ...
    <title>Grand Circus - CoffeShoppe and Cafee</title>
...
<header>
    <div class="header-content">
        <div class="header-content-inner">
            <h1 id="homeHeading">Your Favorite Source of Free Coffee</h1>
            <h2>${message}</h2>
            <hr>
            <p>Register with No Strings Attached!</p>
            <a href="#about" class="btn btn-primary btn-xl page-scroll">Register</a>
        </div>
    </div>
</header>
